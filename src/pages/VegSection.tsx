...
import { vegRecipes } from '../data/vegRecipes';
...
const VegSection = () => {
  ...
  const [filteredRecipes, setFilteredRecipes] = useState(Object.entries(vegRecipes));
  const [searchParams] = useSearchParams();

  const recipesArray = Object.entries(vegRecipes);
          ...
          <div className="mt-12 relative">
            <div className="relative w-64 h-64 mx-auto rounded-3xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-5 left-5 right-5 text-center">
                <h3 className="text-2xl font-bold text-white font-playfair">veg</h3>
              </div>
            </div>
          </div>
        </div>
