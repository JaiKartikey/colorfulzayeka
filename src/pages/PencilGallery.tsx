...
const pencilArtworks = [
  {
    ...
    description: "Detailed graphite portrait showcasing light and shadow mastery",
    image: "index-pencil-1c.jpg",
  ...
  },
  {
    ...
    description: "Precise pencil drawing of architectural elements with fine detail work",
    image: "index-painting-crop.jpg",
    artist: "Colorful Zaaika",
    year: "2024",
    technique: "Technical pencil drawing",
    size: "9x12 inches"
  },
  {
    id: 3,
    title: "Nature Study",
    description: "Botanical illustration rendered in detailed pencil work",
    image: "index-paint3.jpg",
    artist: "Colorful Zaaika",
    year: "2024",
    technique: "Botanical illustration",
    size: "8x10 inches"
  }
];
...
const PencilGallery = () => {
  ...
  const [filteredArtworks, setFilteredArtworks] = useState(pencilArtworks);

  const handleSearch = (query: string) => {
    if (!query.trim()) {
      setFilteredArtworks(pencilArtworks);
      return;
    }

    const filtered = pencilArtworks.filter(artwork =>
        ...
        <div className="max-w-6xl mx-auto px-5 lg:px-7">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-6">
              <Link to="/gallery/watercolor" className="text-white/80 hover:text-brand-primary text-sm font-medium transition-colors">Watercolor</Link>
      ...
      <div className="pt-24 pb-16 px-5 lg:px-7">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed animate-fade-in delay-300 mb-6">
            "The subtle power of graphite – where light and shadow dance in monochromatic harmony"
          </p>
      ...
      <div className="py-16 px-5 lg:px-7">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-300 leading-relaxed">
            Pencil drawing is the foundation of all visual art. In the monochromatic world of graphite, 
            every line carries weight, every shadow holds meaning. My pencil works explore the power of 
            restraint and precision, finding infinite expression within the simple spectrum of black and white.
          </p>
        </div>
      </div>
    </div>
